...
// SHA1 short hash of the SVG bytes. URL only changes when the file actually
// changes, so Camo + browsers cache effectively when nothing's new, and force
// a refetch the instant content changes.
...
// --- Content-hashed cache-bust for both banner variants ---
// Banners are generated by scripts/generate-banner.mjs BEFORE this script runs,
// so the files exist on disk by now.
