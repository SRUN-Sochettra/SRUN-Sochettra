...
<!--START:BANNER-->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/banner-dark.svg?v=ddf0eac0" />
  <source media="(prefers-color-scheme: light)" srcset="./assets/banner-light.svg?v=f887699b" />
  <img src="./assets/banner-dark.svg?v=ddf0eac0" alt="Srun Sochettra" width="100%" />
</picture>
<!--END:BANNER-->
...
<sub>last commit → SRUN-Sochettra.github.io · HTML · 13d ago</sub>
...
<div align="center"><img src="./assets/metrics-social.svg?v=49b5ada6" alt="Stars and people" width="100%" /></div>
<!--END:WORK-->
...
<!--START:LIFE-->
<div align="center"><img src="./assets/metrics-anilist.svg?v=cddefed0" alt="AniList" width="100%" /></div>
<!--END:LIFE-->
