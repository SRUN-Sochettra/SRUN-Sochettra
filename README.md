...
<img src="https://raw.githubusercontent.com/SRUN-Sochettra/SRUN-Sochettra/main/assets/banner.svg?v=1782630883824" alt="Srun Sochettra — live banner" width="100%">
...
- **EggScan v2** — Adding repo comparison mode + GraphQL migration
- **Khmer Banking** — Wired up real KHQR with Bakong sandbox transactions
...
**Daily** — Spring Boot · Next.js · PostgreSQL · TypeScript · Tailwind · Git · Docker

**Comfortable** — React · Flutter · Python · MyBatis · Prisma · Supabase · JWT · Redis · Three.js

**Project-level experience** — LangChain · Groq · Gemini · pgvector · Hugging Face · MicroPython · Raspberry Pi · Arduino

**Exploring** — Rust · Distributed systems · Kubernetes · Infrastructure as code · Advanced AI pipelines

**Languages I think in** — Java, TypeScript, JavaScript, Python, SQL, a bit of Dart and C++
...
<details>
<summary><b>📦 More projects (8 more — coursework, experiments, archives)</b></summary>
...
**Built by Srun Sochettra** · Phnom Penh, Cambodia 🇰🇭

<sub>Small code today, for a better tomorrow • Code for impact.</sub>
