...
<!--START:BANNER-->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/banner-dark.svg?v=1889aef4" />
  <source media="(prefers-color-scheme: light)" srcset="./assets/banner-light.svg?v=9d97e53f" />
  <img src="./assets/banner-dark.svg?v=1889aef4" alt="Srun Sochettra" width="100%" />
</picture>
<!--END:BANNER-->
